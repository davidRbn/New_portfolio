  ...
  return (
    <div className="margin-auto relative flex flex-col items-center ">
      ...
      <div className="z-10">
        ...
        <AnimationScroll delayAnim={0.2}>
          <p className=" relative max-w-xl text-xl">
            <b>Apprenti React.</b> Je suis un développeur web junior passionné
            par React.js. Issu d'une reconversion, je me spécialise dans la
            création d'interfaces modernes et interactives. Toujours avide
            d'apprendre, je cherche à contribuer à des projets innovants et à
            élargir mes compétences en développement web.
          </p>
        </AnimationScroll>
      </div>
    </div>
